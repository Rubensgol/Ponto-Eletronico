...
<body>
    ...
    <body class="text-center">
        <form class="form-signin" action="../acaoCadastroCargo.php" method="post">
            <h1 class="h3 mb-3 font-weight-normal">Cadastre o Cargo</h1>
            <label for="descricao" class="sr-only">Descrição do cargo</label>
